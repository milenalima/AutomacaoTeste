...
After { scenario -> 
	...
	//feature name
	def feature_name = scenario.uri//.feature.title
    //# Scenario name
    def scenario_name = scenario.name
    //# Tags (as an array)
    def scenario_tags = scenario.sourceTagNames

	println " "
	println "## Funcionalidade: ${feature_name}"
	println "# Tag: ${scenario_tags} "
	println "# Cenário: ${scenario_name}"
